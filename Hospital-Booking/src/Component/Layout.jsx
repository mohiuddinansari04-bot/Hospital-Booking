...
function Layout() {
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Hero Section */}
      <div className="px-4 sm:px-6 bg-blue-600 from-blue-600 to-blue-800 text-white py-8 md:py-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4">
          Welcome to the Hospital Booking App
        </h1>
        <p className="text-center text-sm sm:text-base md:text-lg">Your trusted partner for quality healthcare services</p>
      </div>

      {/* Service 1: Day Care Appointments */}
      <div className="px-4 sm:px-6 mt-8 md:mt-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 bg-white rounded-lg shadow-lg p-6 md:p-8">
          {/* Left side */}
      ...
      {/* Call to Action */}
      <div className="px-4 sm:px-6 mt-8 md:mt-10 mb-8 md:mb-10 bg-blue-50 rounded-lg text-center">
        <h3 className="text-xl sm:text-2xl font-bold text-blue-600 mb-4">Ready to Book Your Appointment?</h3>
        ...
        <button className="bg-blue-600 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-bold text-sm sm:text-base md:text-lg hover:bg-blue-700 transition">
          Book Now
        </button>
      </div>
